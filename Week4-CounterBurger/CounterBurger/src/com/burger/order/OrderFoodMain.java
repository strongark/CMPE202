...
public class OrderFoodMain {
    ...
    public static void main(String[] args){
        ...
        System.out.println("After selecting cheese, total burger cost is : $" + burger.cost());

        burger = selectToppings(burger);
        System.out.println("After selecting toppings, total burger cost is : $"  + burger.cost());

        burger = selectPremiumToppings(burger);
        System.out.println("After Premium Toppings total burger cost is : $" + burger.cost());

        burger = selectSauce(burger);
        System.out.println("After selecting sauce total burger cost is : $" + burger.cost());
    ...
    private static Burger selectCheese(Burger burger) {
        ...
        while(cheese != 0) {
            ...
            if (cheese == 1) {
                ...
                if(cnt > 1) {
                    System.out.println("\nCost would be applied for cheese $" + (cnt-1)  );
                }
                break;
            } else {
    ...
    private static Burger selectPremiumToppings(Burger burger){
        ...
        System.out.println("1. ApplewoodSmokedBacon | 2. Avocado | 3. BlackForestHam | 4. Chili | 5. FriedEgg | " +
                "\n6. FriedOnionStrings | 7. HousemadeGuacamole | 8. SauteedMushrooms | 9. SunDriedTomatoes | 0. Go to Next Selection");
    ...
    private static Burger selectToppings(Burger burger){
        ...
        while(toppings != 0) {
            ...
            if (toppings == 1) {
                ...
                if(cnt > 4) {
                    System.out.println("\n Cost would be applied for Toppings $" + (cnt-4) * 0.75  );
                }
                break;
            } else {
                System.out.println("Enter correct selection ");
